     ...
     &     n_,p_,poff_,b_,boff_)
      ...
      subroutine ensBASIS_TRIA_DSLAGRBUBBLE0(trp_,trb_,
     &     n_,p_,poff_,b_,boff_)
      implicit none
      integer n_,poff_,boff_
      double precision b_(boff_,*)
      ...
      do i=1,n_
         ...
         if (trb_.eq.'T') then 
         b_(i,1) = 0.0d0
         b_(i,2) = r*(2.7d1-2.7d1*r)-5.4d1*r*s         
         else 
         b_(1,i) = 0.0d0
         b_(2,i) = r*(2.7d1-2.7d1*r)-5.4d1*r*s         
         endif
      end do
      end subroutine
     ...
     &     poff_,b_,boff_)
      ...
      subroutine ensBASIS_TRIA_DRLAGRBUBBLE0(trp_,trb_,n_,p_,
     &     poff_,b_,boff_)
      implicit none
      integer n_,poff_,boff_
      double precision b_(boff_,*)
